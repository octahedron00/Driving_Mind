...
class Bot_Mind:
    ...
    def __init__(self, show_function = showing_off, go=True):
        ...
        self.mode_list = [
            ...
            # Stanley2CrossMode(pub, 1,   use_green = True),
            Stanley2GreenMode(pub, 1.5, speeding_time=1.0),
            _SheepMode(pub, 0, sleep_sec = SLEEP_SEC),
            Turn2RoadMode(pub, 2,       is_left=True,  is_curve=True),
            ...
            _SheepMode(pub, 0, sleep_sec = SLEEP_SEC),
            Stanley2GreenMode(pub, 24,  left_offset = -10, prefer_dist=230, speeding_time=2.0),
            _SheepMode(pub, 0, sleep_sec = SLEEP_SEC),
            ...
            _SheepMode(pub, 0, sleep_sec = SLEEP_SEC),
            Stanley2GreenMode(pub, 32,  from_it=True, left_offset = -10, prefer_dist=230, speeding_time=2.0),
            _SheepMode(pub, 0, sleep_sec = SLEEP_SEC),
