...
class Bot_Mind:
    ...
    def __init__(self, show_function = showing_off, go=True):
        ...
        self.mode_list = [
            ...
            Turn2VoidMode(pub, 2,       is_left=True, use_road_angle=True, time_ratio = 0.95),
            ...
            Turn2VoidMode(pub, 11,      is_left=True),
            # Turn2RoadMode(pub, 11,      is_left=True),
            Stanley2GreenMode(pub, 12),
            Turn2VoidMode(pub, 13,      is_left=True, use_road_angle=True, time_ratio = 0.9),
            ...
            Turn2VoidMode(pub, 21,      is_left=False, use_road_angle=True),
            # Turn2RoadMode(pub, 21,      is_left=False),
            Stanley2GreenMode(pub, 22,  from_it=True, left_offset=-10),
            Turn2VoidMode(pub, 23,      is_left=False, use_road_angle=True, time_ratio = 0.95),
            ...
            Turn2VoidMode(pub, 25,      is_left=True, use_road_angle=True, time_ratio = 0.95),
            ...
            Turn2VoidMode(pub, 31,      is_left=False),
            ...
            Turn2VoidMode(pub, 41,      is_left=False),
            # Turn2RoadMode(pub, 41,      is_left=False),
            Stanley2GreenMode(pub, 42, from_it=True),
            Turn2VoidMode(pub, 43,      is_left=True, use_road_angle=True, time_ratio = 0.95),
