...
class Bot_Mind:
    ...
    def __init__(self, show_function = showing_off, go=True):
        ...
        self.mode_list = [
            ...
            Turn2VoidMode(pub, 2,       is_left=True, use_road_angle=True),
            ...
            Turn2VoidMode(pub, 13,      is_left=True, use_road_angle=True),
            ...
            Turn2VoidMode(pub, 23,      is_left=False, use_road_angle=True),
            ...
            Turn2VoidMode(pub, 25,      is_left=True, use_road_angle=True),
            ...
            Turn2VoidMode(pub, 43,      is_left=True, use_road_angle=True),
