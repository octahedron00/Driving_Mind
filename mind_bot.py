...
class Bot_Mind:
    ...
    def __init__(self, show_function = showing_off, go=True):
        ...
        self.mode_list = [
            ...
            EventMode(pub, self.model_each, self.shared_list, 10, n_frame = 5, wait_sec = 0.5, show_log= not DO_SECOND, do_step_back=DO_STEP_BACK_FOR_CAM),
            ...
            EventMode(pub, self.model_each, self.shared_list, 30, n_frame = 5, wait_sec = 0.5, show_log= not DO_SECOND, do_step_back=DO_STEP_BACK_FOR_CAM),
